...
class GoOnArc(behavior.Behavior):
    ...
    def add_center(self,center):
        ...
        self.radius = Vector2D(self.kub.state.awayPos[2].x,self.kub.state.awayPos[2].y).dist(self.center)
        self.point = None
    ...
    def execute_setup(self):
        _GoOnArc_.init(self.kub,self.target,self.center,self.radius,True,self.point, self.take_bigger_arc)
        pass
